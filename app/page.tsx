  ...
  return (
    <main className="min-h-screen">
      ...
      >
        ...
        <a href="/our-story" className="nav-link text-sm" style={{ color: "var(--alabaster-dim)" }}>our story</a>
        <a href="/faq" className="nav-link text-sm" style={{ color: "var(--alabaster-dim)" }}>faq</a>
        <a href="/start" className="rounded-full px-4 py-1.5 text-sm"
      ...
      <section className="mx-auto max-w-3xl px-6 pt-24 pb-16 text-center">
        ...
        <a href="/start" className="mt-10 inline-block rounded-md px-8 py-4"
